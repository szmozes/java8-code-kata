...
public class Exercise2Test extends ClassicOnlineStore {
    ...
    public void descSortByAge() {
         ...
         */
        Comparator<Integer> descOrder = (c1, c2) -> -c1.compareTo(c2);
    ...
    public void top3RichCustomer() {
         ...
         */
        Stream<String> top3RichCustomerStream = customerList.stream().sorted((c1, c2) -> -c1.getBudget().compareTo(c2.getBudget())).limit(3).map(Customer::getName);
